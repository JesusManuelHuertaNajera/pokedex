...
class weaknessess extends StatefulWidget{
...
class search_name extends State<weaknessess> {
  //String n;
    ...
    return new Scaffold(
      ...
      GridView.count(crossAxisCount: 3,
        children: pokeHub.pokemon.where((poke) =>
            poke.weaknesses[0].toLowerCase().startsWith(_search.text.toLowerCase())).map((
            poke) =>
